...
<section class="twoColBox">
  ...
  <a href="/chronicle/2025/05/06/a-tiny-analysis-of-nginx-compression-directives-and-a-new-rollup-web-asset-build-size-plugin/" class="card">
    ...
    <div>
      ...
      <p>It will come to no surprise to anyone that web performance is something I hold dear. That said, I did not set out to run this analysis, or fork and write an opinionated rollup plugin, but here we are.</p>
    </div>
  </a>
</section>
